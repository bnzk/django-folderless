...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'File'
        db.create_table(u'folderless_file', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uploader', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owned_files', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'folderless', ['File'])


    def backwards(self, orm):
        # Deleting model 'File'
        db.delete_table(u'folderless_file')
